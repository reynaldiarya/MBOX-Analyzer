...
from .types import AnalyticsResult, Email
...
def generate_csv_content(result: AnalyticsResult) -> str:
    ...
    writer.writerow([
        "Date", "Sender Email", "Sender Name", "Domain", "Subject",
        "Is Spam", "Spam Confidence", "Spam Reasons",
        "Is Newsletter", "Newsletter Confidence", "Newsletter Platform"
    ])
